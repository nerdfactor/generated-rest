 ...
 * @see <a href="http://www.java2s.com/Tutorial/Java/0040__Data-Type/Transformswordstosingularpluralhumanizedhumanreadableunderscorecamelcaseorordinalform.htm" />
 */
public class WordInflector {

	protected static final WordInflector INSTANCE = new WordInflector();

	public static final WordInflector getInstance() {
		return INSTANCE;
	}
	...
	public WordInflector() {
		initialize();
	}

	protected WordInflector(WordInflector original ) {
	...
	@Override
	public WordInflector clone() {
		return new WordInflector(this);
	}
